...
[![Release](https://img.shields.io/github/v/release/RisesunStudios/3x-ui.svg)](https://github.com/RisesunStudios/3x-ui/releases)
[![Build](https://img.shields.io/github/actions/workflow/status/RisesunStudios/3x-ui/release.yml.svg)](https://github.com/RisesunStudios/3x-ui/actions)
[![GO Version](https://img.shields.io/github/go-mod/go-version/RisesunStudios/3x-ui.svg)](#)
[![Downloads](https://img.shields.io/github/downloads/RisesunStudios/3x-ui/total.svg)](https://github.com/RisesunStudios/3x-ui/releases/latest)
[![License](https://img.shields.io/badge/license-GPL%20V3-blue.svg?longCache=true)](https://www.gnu.org/licenses/gpl-3.0.en.html)
[![Go Reference](https://pkg.go.dev/badge/github.com/RisesunStudios/3x-ui/v3.svg)](https://pkg.go.dev/github.com/RisesunStudios/3x-ui/v3)
[![Go Report Card](https://goreportcard.com/badge/github.com/RisesunStudios/3x-ui/v3)](https://goreportcard.com/report/github.com/RisesunStudios/3x-ui/v3)
...
Para documentación completa, visita la [Wiki del proyecto](https://github.com/RisesunStudios/3x-ui/wiki).
